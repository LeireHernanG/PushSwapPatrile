...
/*   Updated: 2026/03/03 17:44:35 by lhernan-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_benchmark(int algorithm, t_totalmoves *totalmoves,float disorder)
{
	...
	printf("\n[bench] total_ops: %d",totalmoves->sa + totalmoves->sb + totalmoves->pa + totalmoves->pb + totalmoves->ra + totalmoves->rb);
    printf("\n[bench] sa :  %d  sb :  %d  pa :  %d  pb :  %d", totalmoves->sa,totalmoves->sb,totalmoves->pa, totalmoves->pb);
    printf("\n[bench] ra :  %d  rb :  %d ",totalmoves->ra, totalmoves->rb); 
